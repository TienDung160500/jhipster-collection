...
class SanXuatHangNgayResourceIT {
    ...
    void createSanXuatHangNgay() throws Exception {
        ...
        restSanXuatHangNgayMockMvc
            .perform(
                post(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(sanXuatHangNgay))
            )
    ...
    void putWithMissingIdPathParamSanXuatHangNgay() throws Exception {
        ...
        restSanXuatHangNgayMockMvc
            .perform(
                put(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(sanXuatHangNgay))
            )
    ...
    void deleteSanXuatHangNgay() throws Exception {
        ...
        restSanXuatHangNgayMockMvc
            .perform(delete(ENTITY_API_URL_ID, sanXuatHangNgay.getId()).accept(MediaType.APPLICATION_JSON))
