...
class ThietBiResourceIT {
    ...
    void createThietBi() throws Exception {
        ...
        // Create the ThietBi
        restThietBiMockMvc
            .perform(post(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(thietBi)))
        ...
        assertThat(testThietBi.getStatus()).isEqualTo(DEFAULT_STATUS);
    }
    ...
    void putNewThietBi() throws Exception {
        ...
        assertThat(testThietBi.getStatus()).isEqualTo(UPDATED_STATUS);
    }
    ...
    void putWithMissingIdPathParamThietBi() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restThietBiMockMvc
            .perform(put(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(thietBi)))
    ...
    void patchWithMissingIdPathParamThietBi() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restThietBiMockMvc
            .perform(patch(ENTITY_API_URL).contentType("application/merge-patch+json").content(TestUtil.convertObjectToJsonBytes(thietBi)))
            .andExpect(status().isMethodNotAllowed());
    ...
    void deleteThietBi() throws Exception {
        ...
        // Delete the thietBi
        restThietBiMockMvc
            .perform(delete(ENTITY_API_URL_ID, thietBi.getId()).accept(MediaType.APPLICATION_JSON))
