...
class QuanLyThongSoResourceIT {
    ...
    void createQuanLyThongSo() throws Exception {
        ...
        restQuanLyThongSoMockMvc
            .perform(post(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(quanLyThongSo)))
    ...
    void putWithMissingIdPathParamQuanLyThongSo() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restQuanLyThongSoMockMvc
            .perform(put(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(quanLyThongSo)))
    ...
    void patchWithMissingIdPathParamQuanLyThongSo() throws Exception {
        ...
        restQuanLyThongSoMockMvc
            .perform(
                patch(ENTITY_API_URL).contentType("application/merge-patch+json").content(TestUtil.convertObjectToJsonBytes(quanLyThongSo))
            )
            .andExpect(status().isMethodNotAllowed());
    ...
    void deleteQuanLyThongSo() throws Exception {
        ...
        restQuanLyThongSoMockMvc
            .perform(delete(ENTITY_API_URL_ID, quanLyThongSo.getId()).accept(MediaType.APPLICATION_JSON))
