...
class ChiTietKichBanResourceIT {
    ...
    void createChiTietKichBan() throws Exception {
        ...
        restChiTietKichBanMockMvc
            .perform(
                post(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(chiTietKichBan))
            )
    ...
    void putWithMissingIdPathParamChiTietKichBan() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restChiTietKichBanMockMvc
            .perform(put(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(chiTietKichBan)))
    ...
    void patchWithMissingIdPathParamChiTietKichBan() throws Exception {
        ...
        restChiTietKichBanMockMvc
            .perform(
                patch(ENTITY_API_URL).contentType("application/merge-patch+json").content(TestUtil.convertObjectToJsonBytes(chiTietKichBan))
            )
            .andExpect(status().isMethodNotAllowed());
    ...
    void deleteChiTietKichBan() throws Exception {
        ...
        restChiTietKichBanMockMvc
            .perform(delete(ENTITY_API_URL_ID, chiTietKichBan.getId()).accept(MediaType.APPLICATION_JSON))
