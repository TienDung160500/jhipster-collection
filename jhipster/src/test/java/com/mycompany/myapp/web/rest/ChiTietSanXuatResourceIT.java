...
class ChiTietSanXuatResourceIT {
    ...
    void createChiTietSanXuat() throws Exception {
        ...
        restChiTietSanXuatMockMvc
            .perform(
                post(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(chiTietSanXuat))
            )
    ...
    void putWithMissingIdPathParamChiTietSanXuat() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restChiTietSanXuatMockMvc
            .perform(put(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(chiTietSanXuat)))
    ...
    void patchWithMissingIdPathParamChiTietSanXuat() throws Exception {
        ...
        restChiTietSanXuatMockMvc
            .perform(
                patch(ENTITY_API_URL).contentType("application/merge-patch+json").content(TestUtil.convertObjectToJsonBytes(chiTietSanXuat))
            )
            .andExpect(status().isMethodNotAllowed());
    ...
    void deleteChiTietSanXuat() throws Exception {
        ...
        restChiTietSanXuatMockMvc
            .perform(delete(ENTITY_API_URL_ID, chiTietSanXuat.getId()).accept(MediaType.APPLICATION_JSON))
