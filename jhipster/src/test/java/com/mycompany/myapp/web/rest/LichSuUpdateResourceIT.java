...
class LichSuUpdateResourceIT {
    ...
    void createLichSuUpdate() throws Exception {
        ...
        restLichSuUpdateMockMvc
            .perform(post(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(lichSuUpdate)))
    ...
    void putWithMissingIdPathParamLichSuUpdate() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restLichSuUpdateMockMvc
            .perform(put(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(lichSuUpdate)))
    ...
    void patchWithMissingIdPathParamLichSuUpdate() throws Exception {
        ...
        restLichSuUpdateMockMvc
            .perform(
                patch(ENTITY_API_URL).contentType("application/merge-patch+json").content(TestUtil.convertObjectToJsonBytes(lichSuUpdate))
            )
            .andExpect(status().isMethodNotAllowed());
    ...
    void deleteLichSuUpdate() throws Exception {
        ...
        restLichSuUpdateMockMvc
            .perform(delete(ENTITY_API_URL_ID, lichSuUpdate.getId()).accept(MediaType.APPLICATION_JSON))
