...
class KichBanResourceIT {
    ...
    void createKichBan() throws Exception {
        ...
        // Create the KichBan
        restKichBanMockMvc
            .perform(post(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(kichBan)))
    ...
    void putWithMissingIdPathParamKichBan() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restKichBanMockMvc
            .perform(put(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(kichBan)))
    ...
    void patchWithMissingIdPathParamKichBan() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restKichBanMockMvc
            .perform(patch(ENTITY_API_URL).contentType("application/merge-patch+json").content(TestUtil.convertObjectToJsonBytes(kichBan)))
            .andExpect(status().isMethodNotAllowed());
    ...
    void deleteKichBan() throws Exception {
        ...
        // Delete the kichBan
        restKichBanMockMvc
            .perform(delete(ENTITY_API_URL_ID, kichBan.getId()).accept(MediaType.APPLICATION_JSON))
