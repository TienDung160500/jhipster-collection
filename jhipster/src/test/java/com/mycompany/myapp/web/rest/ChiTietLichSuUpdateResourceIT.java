...
class ChiTietLichSuUpdateResourceIT {
    ...
    void createChiTietLichSuUpdate() throws Exception {
        ...
        restChiTietLichSuUpdateMockMvc
            .perform(
                post(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(chiTietLichSuUpdate))
            )
    ...
    void putWithMissingIdPathParamChiTietLichSuUpdate() throws Exception {
        ...
        restChiTietLichSuUpdateMockMvc
            .perform(
                put(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(chiTietLichSuUpdate))
            )
    ...
    void deleteChiTietLichSuUpdate() throws Exception {
        ...
        restChiTietLichSuUpdateMockMvc
            .perform(delete(ENTITY_API_URL_ID, chiTietLichSuUpdate.getId()).accept(MediaType.APPLICATION_JSON))
