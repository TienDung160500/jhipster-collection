...
class ThongSoMayResourceIT {
    ...
    void createThongSoMay() throws Exception {
        ...
        restThongSoMayMockMvc
            .perform(post(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(thongSoMay)))
    ...
    void putWithMissingIdPathParamThongSoMay() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restThongSoMayMockMvc
            .perform(put(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(thongSoMay)))
    ...
    void patchWithMissingIdPathParamThongSoMay() throws Exception {
        ...
        restThongSoMayMockMvc
            .perform(
                patch(ENTITY_API_URL).contentType("application/merge-patch+json").content(TestUtil.convertObjectToJsonBytes(thongSoMay))
            )
            .andExpect(status().isMethodNotAllowed());
    ...
    void deleteThongSoMay() throws Exception {
        ...
        restThongSoMayMockMvc
            .perform(delete(ENTITY_API_URL_ID, thongSoMay.getId()).accept(MediaType.APPLICATION_JSON))
