...
public class LichSuUpdate implements Serializable {
    ...
    private Set<ChiTietLichSuUpdate> chiTietLichSus = new HashSet<>();
    ...
    public Set<ChiTietLichSuUpdate> getChiTietLichSus() {
        return this.chiTietLichSus;
    }

    public void setChiTietLichSus(Set<ChiTietLichSuUpdate> chiTietLichSuUpdates) {
    ...
    public LichSuUpdate chiTietLichSus(Set<ChiTietLichSuUpdate> chiTietLichSuUpdates) {
