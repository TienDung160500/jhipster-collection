...
public class SanXuatHangNgay implements Serializable {
    ...
    private Set<ChiTietSanXuat> chiTietSanXuats = new HashSet<>();
    ...
    public Set<ChiTietSanXuat> getChiTietSanXuats() {
        return this.chiTietSanXuats;
    }

    public void setChiTietSanXuats(Set<ChiTietSanXuat> chiTietSanXuats) {
    ...
    public SanXuatHangNgay chiTietSanXuats(Set<ChiTietSanXuat> chiTietSanXuats) {
