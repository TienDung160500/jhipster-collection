...
public class ThietBi implements Serializable {
    ...
    private Set<ThongSoMay> thongSoMays = new HashSet<>();
    ...
    public Set<ThongSoMay> getThongSoMays() {
        return this.thongSoMays;
    }

    public void setThongSoMays(Set<ThongSoMay> thongSoMays) {
    ...
    public ThietBi thongSoMays(Set<ThongSoMay> thongSoMays) {
